...
<header>
    ...
    <form action="https://ileac-churn.000webhostapp.com/Figure/php/controlador.php" method="post" autocomplete="off">
        ...
        <input type="text" name="usuario_usu" id="" placeholder="10 caracteres" maxlength="10" required>

        <label for="">Password</label>
        <input type="password" name="password_usu" id="" placeholder="15 caracteres" maxlength="15" required>
        
        <button type="submit" name="registro"><a href="login.php">Registro</a></button>
    </form>
